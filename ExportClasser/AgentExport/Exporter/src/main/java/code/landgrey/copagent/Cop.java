...
public class Cop {
    public static File agent_work_directory = new File(PathUtils.getCurrentDirectory(), "dumpResult");
...
//        AnsiLog.info("current_jarPth: " + current_jar_path);
        ...
        if(is_boot_start || is_greater_than_jre9 ){
            ...
            AnsiLog.info("java -jar shellchecker.jar -d dumpResult/");
            System.exit(0);
        }else{
            try {
